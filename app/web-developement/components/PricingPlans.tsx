...
const PricingPlans = ({setOpen}:props) => {
  return (
    <div className="w-full max-w-[1246px] mx-auto py-10 flex flex-col xl:flex-row justify-between items-end">
      ...
      <div className="flex flex-col max-xl:mb-10 lg:flex-row bg-white border border-r-0 max-xl:rounded-r-xl rounded-r-none rounded-xl overflow-hidden w-full h-[1000px] lg:h-[560px]  lg:min-w-[610px] shadow-md">
        {/* Intro Card */}
        <div className="relative flex-1 p-[10px] md:p-[32px] ">
