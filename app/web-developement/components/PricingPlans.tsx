    ...
    <div className="w-full max-w-[1246px] mx-auto py-10 flex flex-col xl:flex-row justify-between items-end">
      ...
      <div className="flex flex-col max-xl:mb-10 lg:flex-row bg-white border border-r-0 max-xl:rounded-r-xl rounded-r-none rounded-xl overflow-hidden w-full h-[1100px] lg:h-[560px]  lg:min-w-[610px] shadow-md">
        ...
        <div className="relative flex-1 p-[10px] min-h-fit md:p-[32px] ">
          ...
          <p className="mt-4 text-[28px] text-[#231D4F] leading-[100%] font-normal">
            Intro <span className="pl-[19px] text-[15px] tracking-[0px] leading-[100%] text-[#AA253D]">5-day delivery</span>
          </p>
          ...
          <button onClick={()=>setOpen(true)} className="absolute bottom-8 md:bottom-5 mt-[14px] md:mt-[34px] w-[90%] md:w-[220px] mx-auto py-3 rounded-full bg-[#AA253D] text-white hover:bg-[#94273b] transition-all duration-200">
            Choose plan
          </button>
        </div>
      ...
      <div className="relative max-xl:mb-10 bg-gradient-to-b from-[#AA253D] to-[#5D0554] mb-2 text-white p-[10px] md:p-[32px] rounded-xl shadow-xl max-xl:w-[100%] w-[100%] md:min-w-[311px] md:h-[607px] max-md:pb-20 flex flex-col justify-between scale-[1.03]">
        ...
        <div className="w-full mt-[15px]">
          ...
          <p className="mt-2 text-[28px]">Pro <span className="ml-[19px] text-[15px] tracking-[0px] leading-[100%] text-white">25-day delivery</span></p>
          ...
          <ul className="space-y-[10.65px]  text-[15px] text-white leading-[100%] tracking-[0px]">
            <li className="flex items-start space-x-[8.7px]">
              ...
              <span className="w-[212px]">Unlimited content pages and complex layouts</span>
            </li>
            <li className="flex items-start space-x-[8.7px]">
              <span className="w-[21.3px] h-[21.3px] bg-[#0000001A] rounded-[50%] content-center">
                <Image src={check} alt="" className="flex mx-auto" />
              </span>
              <span className="w-[212px]">Advanced Content management system</span>
            </li>
            <li className="flex items-start space-x-[8.7px]">
              <span className="w-[21.3px] h-[21.3px] bg-[#0000001A] rounded-[50%] content-center">
                <Image src={check} alt="" className="flex mx-auto" />
              </span>
              <span className="w-[212px]">Advanced functionality (Chat systems, Live features etc)</span>
            </li>
            <li className="flex items-start space-x-[8.7px]">
              <span className="w-[21.3px] h-[21.3px] bg-[#0000001A] rounded-[50%] content-center">
                <Image src={check} alt="" className="flex mx-auto" />
              </span>
              <span className="w-[212px]">Detailed analytics tracking and reporting setup.(google analytics ,Monster Insights etc)</span>
            </li>
        ...
        <button onClick={()=>setOpen(true)} className="absolute max-md:-bottom-4 max-md:w-[90%] bottom-8  md:w-[220px] max-xl:w-full mx-auto md:-mb-[10px] max-md:mb-10  py-3 rounded-full text-[15px] font-normal border-white border text-white hover:border-[2px] transition-all duration-100 hover:bg-gradient-to-r from-[#dc2430] to-[#7b4397]">
          Choose plan
        </button>
      </div>
