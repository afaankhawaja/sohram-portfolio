      ...
      <div className="lg:h-[806px] bg-[#F2F4F7] rounded-[50px] w-[100%] mx-auto flex flex-row-reverse max-lg:flex-col max-lg:gap-y-5 justify-center items-center gap-x-2">
        ...
        <div className="flex flex-col max-md:w-[80%] mx-auto -mt-2 lg:max-w-[696px] max-lg:mt-10 max-lg:mb-10 px-5">
          ...
          <button
            ...
            className="max-w-[215px] max-md:min-w-[180px] max-md:mx-auto max-h-[104px] text-[#151515] border border-[#151515] rounded-[32px] mt-[25px] md:text-[32px] font-semibold -tracking-[1.5%] leading-[100%] text-center md:px-[59px] px-[20px] md:py-[33px] py-[15px] hover:bg-[#AA253D] transition-all duration-300 hover:text-white"
          >
            Hire us
          </button>
        </div>
