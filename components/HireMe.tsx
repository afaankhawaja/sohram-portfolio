...
const HireMe = () => {
  return (
    <section>
       ...
       <button className='max-w-[215px] max-h-[104px] text-[#151515] border border-[#151515] rounded-[32px] mt-[47px] text-[32px] font-semibold -tracking-[1.5%] leading-[100%] text-center content- px-[59px] py-[33px]'>
        Hire us
       </button>
        </div>
         </div>
