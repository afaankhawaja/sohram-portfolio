        ...
        <div className="flex flex-col max-md:w-[80%] -mt-2 md:max-w-[696px] max-lg:mt-10 max-lg:mb-10 px-5">
          ...
          <div className="flex gap-x-2">
            ...
            <div className="flex flex-col  gap-y-[2px]">
              <Image src={con} alt="" className="-ml-2" />
          ...
          <button
            ...
            className="max-w-[215px] max-md:min-w-[180px]  max-md:mx-auto max-h-[104px] text-[#151515] border border-[#151515] rounded-[32px] mt-[47px] md:text-[32px] font-semibold -tracking-[1.5%] leading-[100%] text-center content- md:px-[59px] px-[20px] md:py-[33px] py-[15px] hover:bg-[#AA253D] transition-all duration-300 hover:text-white"
          >
            Hire us
          </button>
        </div>
